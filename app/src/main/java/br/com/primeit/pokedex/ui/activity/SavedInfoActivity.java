...
public class SavedInfoActivity extends AppCompatActivity {
    ...
    private Long chooseColor(String nomeTipo) {
        ...
        switch (nomeTipo) {
            case "grass":
                color = ContextCompat.getColor(this, R.color.type_grass);
                break;
            case "fire":
                color = ContextCompat.getColor(this, R.color.type_fire);
                break;
            case "water":
                color = ContextCompat.getColor(this, R.color.type_water);
                break;
            case "electric":
                color = ContextCompat.getColor(this, R.color.type_electric);
                break;
            case "poison":
                color = ContextCompat.getColor(this, R.color.type_poison);
                break;
            case "flying":
                color = ContextCompat.getColor(this, R.color.type_flying);
                break;
            case "bug":
                color = ContextCompat.getColor(this, R.color.type_bug);
                break;
            case "psychic":
                color = ContextCompat.getColor(this, R.color.type_psychic);
                break;
            case "ghost":
                color = ContextCompat.getColor(this, R.color.type_ghost);
                break;
            case "steel":
                color = ContextCompat.getColor(this, R.color.type_steel);
                break;
            case "rock":
                color = ContextCompat.getColor(this, R.color.type_rock);
                break;
            case "fighting":
                color = ContextCompat.getColor(this, R.color.type_fight);
                break;
            case "fairy":
                color = ContextCompat.getColor(this, R.color.type_fairy);
                break;
            case "dragon":
                color = ContextCompat.getColor(this, R.color.type_dragon);
                break;
            case "ice":
                color = ContextCompat.getColor(this, R.color.type_ice);
                break;
            case "dark":
                color = ContextCompat.getColor(this, R.color.type_dark);
                break;
            case "normal":
                color = ContextCompat.getColor(this, R.color.type_normal);
                break;
            case "ground":
                color = ContextCompat.getColor(this, R.color.type_ground);
                break;
            default:
                color = R.color.red_pokedex;
        }
